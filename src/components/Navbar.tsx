...
export class Navbar extends Component<ModeType> {
    render() {
        const {handleOn, handleOf} = this.props
        const image = "https://reactnative.dev/img/logo-og.png"
        return (
            <div className="navbar bg-white shadow-md sticky z-10 top-0 sticky">
            <div className="flex-1 ">
            <ul className="menu menu-horizontal p-1">
                <li>
                <a href="" className='hover:bg-slate-400 hover:text-white'>MyMovies</a>
                </li>
                <li>
                <a href="" className='hover:bg-slate-400 hover:text-white'>Home</a>
                </li>
                <li>
                <a href="" className='hover:bg-slate-400 hover:text-white'>Favorites</a>
                </li>
            </ul>
            </div>
